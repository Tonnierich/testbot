...
import Blockly from "blockly" // Declare the Blockly variable
...
export const createDetails = (contract) => {
  ...
  return [
    ...
    formatTime(Number.parseInt(`${contract.entry_tick_time}000`), "HH:mm:ss"),
    +contract.entry_tick,
    formatTime(Number.parseInt(`${contract.exit_tick_time}000`), "HH:mm:ss"),
    +contract.exit_tick,
